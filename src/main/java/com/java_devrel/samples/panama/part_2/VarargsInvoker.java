...
class VarargsInvoker {
    ...
    static MethodHandle make(Linker linker, MemorySegment symbol, FunctionDescriptor function) {
        ...
        MethodHandle handle = INVOKE_MH
                // Binds a value of 'VarargsInvoker' to the first argument of an 'invoke'
                // method handle, without invoking it.
                .bindTo(invoker)
                // creates an array-collecting method
                .asCollector(Object[].class, function.argumentLayouts().size() + 1);
        // retrieves a method type based in a function ret-value layout, if present
        // returns a potential ret-value holder based in ret-value layout (one of three):
        //   - an Addressable (MemorySegment and MemoryAddress),
        //   - a MemorySegment,
        //   - void.
        ...
        // extending method type with a carrier layout of each argument of a function
        ...
        // at this sage we have a "repacked" method handle extended with varargs
